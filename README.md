...
[![Version](https://img.shields.io/badge/version-0.4.4-blue.svg)](https://github.com/j2st1n/panstar-akile-marketplace-tool)
...
### v0.4.4
- **面板标题亲和度优化**：将原本晦涩的内部技术代号“⚡ XRV 交易所助手”正式更名为“**⚡ 交易所剩余价值助手**”（英文模式同步为 `⚡ Marketplace Value Assistant`），使工具定位与品牌感知更加直观接地气。
